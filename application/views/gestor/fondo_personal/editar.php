<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $this->lang->line('heading_title_transactions_edit'); ?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="index.html"><?php echo $this->lang->line('heading_home_transactions_edit'); ?></a>
            </li>
            
            <li>
                <a href="<?php echo base_url() ?>transactions"><?php echo $this->lang->line('heading_subtitle_transactions_edit'); ?></a>
            </li>
           
            <li class="active">
                <strong><?php echo $this->lang->line('heading_info_transactions_edit'); ?></strong>
            </li>
        </ol>
    </div>
</div>
        ...
        <div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5><?php echo $this->lang->line('edit_title'); ?></h5>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<label style="color:red;">
						(<?php echo $this->lang->line('edit_approved_capital'); ?>: <span id="span_capital_aprobado"></span>
				...
				<div class="ibox-content">
					<form id="form_transactions" method="post" accept-charset="utf-8" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_type'); ?> *</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_user'); ?> *</label>
							<div class="col-sm-10">
						...
						<!-- Fin validación -->
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_project'); ?> *</label>
							<div class="col-sm-10">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_account'); ?> *</label>
							<div class="col-sm-10">
						...
						<div class="form-group"><label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_date'); ?></label>
							<div class="col-sm-10">
								<?php 
								$fecha = $editar[0]->date;
								$fecha = explode(" ", $fecha);
						...
						<div class="form-group"><label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_description'); ?></label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="description" maxlength="250" id="description" value="<?php echo $editar[0]->description; ?>"/>
							</div>
						</div>
						<div class="form-group"><label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_reference'); ?></label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="reference" maxlength="100" id="reference" value="<?php echo $editar[0]->reference; ?>"/>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_observations'); ?></label>
							<div class="col-sm-10">
								<textarea class="form-control" name="observation" maxlength="250" id="observation"><?php echo $editar[0]->observation; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label" ><?php echo $this->lang->line('edit_amount'); ?> *</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="amount" id="amount" value="<?php echo number_format($editar[0]->amount, $editar[0]->coin_decimals, '.', ''); ?>" onkeypress="return valida_monto(event)">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label"><?php echo $this->lang->line('edit_real'); ?></label>
							<div class="col-sm-10">
								<div class="i-checks">
									<label>
										<?php if($editar[0]->real == 0){ ?>
						...
						<div class="form-group">
							<label class="col-sm-2 control-label"><?php echo $this->lang->line('edit_rate'); ?></label>
							<div class="col-sm-10">
								<input type="text" class="form-control" name="rate" id="rate" value="<?php echo $editar[0]->rate; ?>">
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label"><?php echo $this->lang->line('edit_document'); ?></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<div class="col-sm-4 col-sm-offset-2">
								...
								<button class="btn btn-white" id="volver" type="button"><?php echo $this->lang->line('edit_back'); ?></button>
								<button class="btn btn-primary" id="edit" type="submit"><?php echo $this->lang->line('edit_save'); ?></button>
							</div>
						</div>
					</form>
				</div>
...
$(document).ready(function(){
    ...
    $.post('https://openexchangerates.org/api/latest.json?app_id=65148900f9c2443ab8918accd8c51664', function (coins) {
		...
		$.post('https://openexchangerates.org/api/latest.json?app_id=1d8edbe4f5d54857b1686c15befc4a85', function (coins) {
			...
			var valor1btc, valor1anycoin, rate = $("#iso_currency_user").val().trim(), rates = [], cryptos;
