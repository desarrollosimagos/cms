...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <p></p>
            <form class="m-t" role="form" action="<?php echo base_url()."users/add_public"?>" method="post">
                ...
                <button type="submit" class="btn btn-primary block full-width m-b"><?php echo $this->lang->line('register_button_value'); ?></button>

                <p class="text-muted text-center"><small><?php echo $this->lang->line('register_question_account'); ?></small></p>
                <a class="btn btn-sm btn-white btn-block" href="<?php echo base_url()."login"?>"><?php echo $this->lang->line('register_login_account'); ?></a>
            </form>
