...
<div class="wrapper wrapper-content animated fadeInUp">
	...
	<div class="ibox">
		<div class="ibox-title">
			<h5><?php echo $this->lang->line('view_list_summary_platform_title_projects'); ?></h5>
		...
		<div class="ibox-content">
			...
			<table id="tab_transactions_user" data-page-size="10" data-filter=#filter2 class="footable table table-stripped toggle-arrow-tiny">
				<thead>
					<tr>
						<!--<th>#</th>
						<th data-hide="phone,tablet" >Nombre</th>
						<th data-hide="phone,tablet" >Alias</th>-->
						<th data-hide="phone,tablet" ><?php echo $this->lang->line('view_list_platform_invested_capital_projects'); ?></th>
						<th data-hide="phone,tablet" ><?php echo $this->lang->line('view_list_platform_dividend_projects'); ?></th>
						<th data-hide="phone,tablet" ><?php echo $this->lang->line('view_list_platform_capital_in_project_projects'); ?></th>
					</tr>
				</thead>
				<tbody>
					<?php $i = 1; ?>
					<tr style="text-align: center">
						...
						<td>
							<?php echo $project_transactions_gen['resumen_plataforma']->name; ?>
						</td>
						<td>
							<?php echo $project_transactions_gen['resumen_plataforma']->alias; ?>
						</td>-->
						<td>
							<?php echo $project_transactions_gen['resumen_plataforma']->capital_invested; ?>
						</td>
						<td>
							<?php echo $project_transactions_gen['resumen_plataforma']->returned_capital; ?>
						</td>
						<td>
							<?php echo $project_transactions_gen['resumen_plataforma']->capital_in_project; ?>
						</td>
					</tr>
				</tbody>
				<tfoot>
