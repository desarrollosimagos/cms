...
<div class="wrapper wrapper-content animated fadeInRight">
	...
	<div class="row"><!-- Apertura de línea -->
		...
		<div class="col-lg-12">
			<h2><?php echo $this->lang->line('public_list_title_projects'); ?> (<?php echo $current_events; ?>)</h2>
		</div>
		...
		<?php foreach($listar as $proyecto){ ?>
			<?php if($proyecto->availability == 'current'){ ?>
			<div class="col-lg-3">
					...
					<div>
						...
						<div class="ibox-content profile-content">
							...
							<div class="row user-button">
								<div class="row">
									<div class="col-md-12" align="center">
										<a type="button" href="<?php echo base_url();?>events/inscription?project_id=<?php echo $proyecto->id?>" class="btn btn-primary btn-sm btn-block b-r-xl learn-more">
	...
	<div class="row"><!-- Apertura de línea -->
		...
		<div class="col-lg-12">
			<h2><?php echo $this->lang->line('public_list_title2_projects'); ?> (<?php echo $upcoming_events; ?>)</h2>
		</div>
		...
		<!-- Apertura de ciclo -->
		<?php foreach($listar as $proyecto){ ?>
			<?php if($proyecto->availability == 'upcoming'){ ?>
			<div class="col-lg-3">
				<div class="ibox float-e-margins">
					<!--<div class="ibox-title">
						<h5>Profile Detail</h5>
	...
	<div class="row"><!-- Apertura de línea -->
		...
		<div class="col-lg-12">
			<h2><?php echo $this->lang->line('public_list_title3_projects'); ?> (<?php echo $past_events; ?>)</h2>
		</div>
		...
		<!-- Apertura de ciclo -->
		<?php foreach($listar as $proyecto){ ?>
			<?php if($proyecto->availability == 'past'){ ?>
			<div class="col-lg-3">
				<div class="ibox float-e-margins">
					<!--<div class="ibox-title">
						<h5>Profile Detail</h5>
