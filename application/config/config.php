...
|
*/
$config['base_url'] = 'http://coms.imago.web.ve/';
...
*/
$config['title_app'] = 'COMS';
$config['title_app_login'] = 'COMS | Login';
...
//~ $config['public_menu'][] = array('Ver Eventos', $config['base_url'].'investments', 1);
